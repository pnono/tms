...
SECRET_KEY = 'r9i2dxtiun6ha9$7(=)319)3^&l)6ymu*4kbg@v$4$i*j@_o4y'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tms', ## change this to fit your sql server
	'USER': 'tmadmin', ## change this
	'PASSWORD': 'timesheet', ## change this
	'HOST': '127.0.0.1'
    }
}
